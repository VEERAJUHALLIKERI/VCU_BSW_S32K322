...
/* Check if Adc_Sar_Ip_Cfg.h file and Adc_Sar_Ip_BOARD_InitPeripherals_PBcfg.h file are of the same vendor */
#if (ADC_SAR_IP_VENDOR_ID_CFG != ADC_SAR_IP_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG)
    #error "Adc_Sar_Ip_Cfg.h and Adc_Sar_Ip_BOARD_InitPeripherals_PBcfg.h have different vendor ids"
#endif

/* Check if Adc_Sar_Ip_Cfg.h file and Adc_Sar_Ip_BOARD_InitPeripherals_PBcfg.h file are of the same Autosar version */
#if ((ADC_SAR_IP_AR_RELEASE_MAJOR_VERSION_CFG != ADC_SAR_IP_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_CFG != ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_CFG != ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG) \
    )
    #error "AutoSar Version Numbers of Adc_Sar_Ip_Cfg.h and Adc_Sar_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif

/* Check if Adc_Sar_Ip_Cfg.h file and Adc_Sar_Ip_BOARD_InitPeripherals_PBcfg.h file are of the same Software version */
#if ((ADC_SAR_IP_SW_MAJOR_VERSION_CFG != ADC_SAR_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_SW_MINOR_VERSION_CFG != ADC_SAR_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_SW_PATCH_VERSION_CFG != ADC_SAR_IP_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG) \
    )
  #error "Software Version Numbers of Adc_Sar_Ip_Cfg.h and Adc_Sar_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif

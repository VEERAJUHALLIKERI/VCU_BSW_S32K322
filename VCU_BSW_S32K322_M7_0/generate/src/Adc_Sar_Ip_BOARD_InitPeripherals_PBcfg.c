...
#define ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C      7
#define ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_C   0
#define ADC_SAR_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C              3
#define ADC_SAR_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C              0
...
#if (ADC_SAR_IP_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG)
...
#if ((ADC_SAR_IP_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG) \
    )
...
#if ((ADC_SAR_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG) || \
     (ADC_SAR_IP_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != ADC_SAR_IP_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG) \
    )
